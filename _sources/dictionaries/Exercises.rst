...
.. mchoice:: Exercises_question9_1
  ...
  :answer_d: fruit[15] = 'grapes'
  :correct: b
  :feedback_a: Try again! This does not add a value.
  :feedback_b: Correct! This line add ``grapes`` as a key with a value of ``15``.
...
.. mchoice:: Exercises_question9_3
   ...
   :feedback_d: Try again! This will not add Eleanor since the value is 2.
...
.. mchoice:: Exercises_question9_5
   ...
   Which line(s) of code correctly gets the value of the key ``apples`` if it exists and return 0 if it does not?
...
.. mchoice:: Exercises_question9_6
   ...
   :feedback_d: Try again!  This would be true if it just printed the value for the key 'o', but it adds 4 to it.
...
.. mchoice:: Exercises_question9_7_v2
   ...
   :correct: c
   :feedback_a: Dictionaries now store keys in order.
   :feedback_b: Dictionaries now store keys in order.
   :feedback_c: Dictionaries now store keys in order.
   :feedback_d: Dictionaries now store keys in order.
...
.. mchoice:: Exercises_question9_8_v2
  ...
  :answer_d: jan, annie, chuck
  :correct: a
  :feedback_a: This will sort by the keys in descending order.
  :feedback_b: Correct! This will sort by the keys in descending order.
...
.. mchoice:: Exercises_question9_9_v2
  ...
  :answer_d: jan, annie, chuck
  :correct: b
  :feedback_a: This will sort by the values in acending order.
  :feedback_b: Correct! This will sort by the values in acending order.
  :feedback_c: This will sort by the values in acending order.
  :feedback_d: This will sort by the values in acending order.
...
.. mchoice:: Exercises_question9_10_v2
  ...
  :feedback_c: This will print the keys in their current order since sorted returns a new list.
