...
.. dragndrop:: chapter_ten_glossary_one
   :feedback: If you're stuck, look above for the definitions of these terms!
...
.. dragndrop:: chapter_ten_glossary_two
   :feedback: If you're stuck, look above for the definitions of these terms!
   :match_1: shape(of a data structure)|||A summary of the type, size, and composition of a data structure.
   :match_2: singleton|||A list (or other sequence) with a single element.
   :match_3: tuple|||An immutable sequence of elements.
   :match_4: tuple assignment|||An assignment with a sequence on the right side and a tuple of variables on the left. The right side is evaluated and then its elements are assigned to the variables on the left.
