...
.. mchoice:: ctp-iterations-04_moreloops_11
   ...
   -   
       ...
       -  Incorrect! Although there will be 5 iterations, it will not print 5 rows and columns of *. With each iteration, i columns of * will be printed. It will generate a staircase pattern.
   ...
   -   
       ...
       +  Correct! This will print 5 rows and columns of *. There will be 5 iterations. With each iteration, n=5 columns of * will be printed. 
   ...
   -   
       ...
       -  Incorrect! This will print 4 rows and 5 columns of *. There will be 4 iterations, starting from 1 through n-1=4. With each iteration, n=5 columns of * will be printed.  

   -   I don’t know

       -  Incorrect! Print n=5 columns of *. Run a for loop to print n=5 rows.
