...
.. parsonsprob:: bsoup_writecode2q_mu
	...
	=====
	  headings = soup.find('li', class_ = 'toclevel-1') #paired
	=====
	  for tag in headings:
	=====
			a_tag = tag.find('a') 
	...
	=====
		heading = tag.find(class= 'toctext').text #paired
	=====
...
.. parsonsprob:: bsoup_writecode3q_mu
	...
	=====
	table = soup.find_all('table', class_ = 'wikitable') #paired
	=====
...
.. parsonsprob:: bsoup_writecode5q_mu
	...
	=====
	restaurants = soup.find_all('div', class = "c-mapstack__card-hed") #paired
	=====
