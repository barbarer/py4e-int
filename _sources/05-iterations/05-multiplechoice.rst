...
.. mchoice:: e5mc4
   ...
   :answer_d: Number: 11
   :correct: a
   :feedback_a: Correct! Since this while loop continues while number is less than or equal to 10 the last time in the loop it will print Number: 10.
   :feedback_b: Try again! This would be true if it was print ("Number: ", "number"). But since there are no quotes around number it will print the value of number.
   :feedback_c: Try again! While number is set to 0 to start it increments each time inside the loop.
   :feedback_d: Try again! This would be true if the print statement was after number was incremented by 1, but it is before.
...
.. mchoice:: e5mc5
   ...
   :answer_d: 4
   :correct: c
   :feedback_a: Try again! This would be true if the print was outside of the loop, but it is in the loop.
   :feedback_b: Try again! This would be true if it was range(1,3)
   :feedback_c: Correct! The range(1,4) returns a list with the values 1, 2, and 3. So this will print hello 3 times.
   :feedback_d: Try again! This would be true if it was range(1,5). Remember that it includes the first value and ends before the second value.
