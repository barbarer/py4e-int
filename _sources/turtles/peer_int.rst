...
.. mchoice:: ctp-recursion-17_fractals_11
   :author: Cynthia Taylor
    ...
    :answer_c: Draw a triangle
    :answer_d: Draw a line with a pointy bit
    :answer_e: I don't know
    :correct: b
    :feedback_a: Try again. We need to draw something to start. And a flat line will be the base case in our recursive function.
    :feedback_b: Correct! A flat line will be the base case in our recursive function.
    :feedback_c: Try again. What does a triangle consist of? A flat line right?
    :feedback_d: Try again. No pointy bit is necessary here. A flat line will be the base case in our recursive function.
    :feedback_e: Try again. A flat line will be the base case in our recursive function.
...
.. mchoice:: ctp-recursion-17_fractals_15
    ...
    :answer_b: 60, 30, 60
    :answer_c: 60, 240, 60
    :answer_d: 120, 240, 120
    :answer_e: I don't know
    :correct: c
    :feedback_a: Try again. The new pattern draws an equilateral triangle on each middle part of the original triangle. The angle of rotation is the angle or the supplementary angle of equilateral triangle.
