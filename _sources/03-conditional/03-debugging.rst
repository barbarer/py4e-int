...
.. fillintheblank:: cndtnl-debug-fitb-weight
   ...
   -    :^1$|1\.[0]*$: Correct! The code checks for numbers greater or less than 1, but not 1 itself.
...
.. mchoice:: cndtnl-debug-mc-error
    ...
    :feedback_c: Correct! Dividing by z (0) will cause an error.
...
.. mchoice:: cndtnl-debug-mc-error2
    ...
    :feedback_c: Correct! Since y = 0, x/y will cause en erorr. The gaurd (y != 0) should be placed before that expression.
