...
question below to the best of your ability.  Start with the practice and then do the posttest problems 1 and 2.
...
.. selectquestion:: sum13_selq-p
   :ab: disPPEx1
   :fromid: sum13_nd_pp_exA, sum13_w6d_pp_exB

.. poll:: sum13_pp_poll-p
    :allowcomment:
...
.. selectquestion:: list_mult_selq-p
   :ab: disPPEx1
   :fromid: list_multiples_pp_exA, list_multiples_w3d_pp_exB

.. poll:: list_multiples_pp_poll-p
    :allowcomment:
    :option_1: Very, very low mental effort
    :option_2: Very low mental effort
    :option_3: Low mental effort
...
.. selectquestion:: ibeforee_selq-p
   :ab: disPPEx1
   :fromid: ibeforee_pp_exA, ibeforee_pp_wd_exB

.. poll:: ibeforee_pp_poll-p
    :allowcomment:
    :option_1: Very, very low mental effort
    :option_2: Very low mental effort
    :option_3: Low mental effort
...
.. selectquestion:: remove_target_selq-p
   :ab: disPPEx1
   :fromid: removetarget_pp_v2_exA, remove_target_pp_wd_exB

.. poll:: removetarget_pp_v2_poll-p
    :allowcomment:
    :option_1: Very, very low mental effort
    :option_2: Very low mental effort
    :option_3: Low mental effort
...
.. timed:: post-exa-1-1
   ...
   .. activecode:: removeExtras_fix_timed-p
      :autograde: unittest
...
.. poll:: removeExtras_fix_timed_poll-p
    :allowcomment:
    :option_1: Very, very low mental effort
    :option_2: Very low mental effort
    :option_3: Low mental effort
...
.. timed:: post-exa-2-p
   ...
   .. activecode:: find_extras_fix_timed-p
      :autograde: unittest
...
.. poll:: find_extras_fix_timed_poll-p
    :allowcomment:
    :option_1: Very, very low mental effort
    :option_2: Very low mental effort
    :option_3: Low mental effort
