...
.. mchoice:: objects_mcq10_4
    ...
    What should be in the underlined section in the ``getX`` and ``getY`` methods of the ``Point`` class?
    ::
...
.. mchoice:: objects_mcq10_8
    ...
    Which of the following is the correct way to define a constructor (initializer)?
...
.. mchoice:: objects_mcq10_9
    ...
    :answer_d: instance
    :correct: a
    :feedback_a: Correct! The class keyword defines a template for objects of the class, but does not create the object.
...
.. mchoice:: objects_mcq10_10
    ...
    :feedback_c: Correct! The 'self' is not a keyword, but by convention is used to represent the current object.
