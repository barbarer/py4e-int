...
.. parsonsprob:: Functions_MixedUpCode_1P_v2
    ...
    Create a function called ``exp`` that takes in two parameters, ``num1`` and ``num2`` that returns ``num1`` raised to the
    ``num2`` power. For example, ``exp(2,3)`` should return ``8``.
...
.. activecode:: Functions_MixedUpCode_1P_v2_ac
   ...
   Write a function called ``exp`` that takes in two parameters, ``num1`` and ``num2`` that returns ``num1`` raised to the
   ``num2`` power. For example, ``exp(2,3)`` should return ``8``.
   ~~~~
